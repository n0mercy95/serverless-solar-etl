...
Dado que este proyecto de Energía Solar es robusto y sigue una **Arquitectura de Capas (Clean Architecture)**, los roles deben ser más específicos para cubrir no solo BigQuery, sino también Cloud Storage y el manejo de logs.
